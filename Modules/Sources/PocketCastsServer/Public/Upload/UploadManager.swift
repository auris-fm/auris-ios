...
public class UploadManager: NSObject {
    ...
    private lazy var wifiOnlyBackgroundSession: URLSession = {
        var config = URLSessionConfiguration.background(withIdentifier: "fm.auris.PCUploadBackgroundSession")
    ...
    private lazy var cellularBackgroundSession: URLSession = {
        var config = URLSessionConfiguration.background(withIdentifier: "fm.auris.PCUploadManualSession")
